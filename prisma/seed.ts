  ...
  await prisma.lesson.createMany({
    data: [
      ...
      },
      {
        courseId: course1.id,
        order: 2,
        titleHt: 'Vokabilè Travay',
        titleFr: 'Vocabulaire Professionnel',
        contentHt: 'Aprann mo yo ki pi enpòtan nan mond travay la.',
        contentFr: 'Apprenez les mots les plus importants du monde du travail.',
        duration: 45,
        isPublished: true,
      }
    ]
