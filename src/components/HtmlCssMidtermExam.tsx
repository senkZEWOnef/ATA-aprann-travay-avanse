      ...
      if (question.type === 'multiple-choice') {
        ...
        if (userAnswer && typeof userAnswer === 'string') {
          ...
          if (userAnswerLower === correctAnswerLower) {
            ...
            // Check acceptable answers for partial credit
            const matchesAcceptable = question.acceptableAnswers.some(acceptable => 
              userAnswerLower.includes(acceptable.toLowerCase()) || 
              acceptable.toLowerCase().includes(userAnswerLower)
            );
